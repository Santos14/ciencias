          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
              ...
              <?php
                    ...
                    {
                        $idgrado_instruccion = $datos->idgrado_instruccion;
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>Instruccion_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idgrado_instruccion" value="<?php echo $idgrado_instruccion; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Instruccion_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
