          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                       <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>Aspectos_c/nuevo">Agregar Nuevos Aspectos </a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php print $value->da; ?></td>
                                 <td><?php print $value->dn; ?></td>
                                <td><?php print $value->estado; ?></td>
                                <td><a href="<?php echo base_url()."Aspectos_c/modificar/".$value->idaspecto; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Aspecto?');"
                                href="<?php echo base_url()."Aspectos_c/eliminar/".$value->idaspecto; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
