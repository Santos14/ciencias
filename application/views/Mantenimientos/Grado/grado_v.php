            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                    ...
                    <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>Grado_c/nuevo">Agregar Nuevo Grado</a>
                    ...
                    <table class="table table-bordered table-striped table-condensed buscar" border>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php print $value->dg; ?></td>
                                 <td><?php print $value->dn; ?></td>
                                <td><?php print $value->estado; ?></td>
                                <td><a href="<?php echo base_url()."Grado_c/modificar/".$value->idgrado; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Grado?');"
                                href="<?php echo base_url()."Grado_c/eliminar/".$value->idgrado; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
