                 ...
                 <?php
                    ...
                    else
                    {
                        ...
                        $descripcion = $datos->descripcion;
                         $idtipo_movimiento = $datos->idtipo_movimiento;
                    }
                 ?>
                 <div class="row">
                     <div class="col-md-9">

                       <form action="<?php echo base_url(); ?>Concepto_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idconcepto" value="<?php echo $idconcepto; ?>">
                            ...
                            <select name="idtipo_movimiento" id="" class="combobox form-control">
                                <option value=""></option>
                                <?php foreach($movimiento as $value){
                                    if($idtipo_movimiento == $value->idtipo_movimiento){
                                    ?>
                                    <option selected value="<?php echo $value->idtipo_movimiento; ?>"><?php echo $value->descripcion; ?></option>
                                    <?php }else{ ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Concepto_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
