                ...
                <div class="main-content-inner">
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>Cargo_c/nuevo" method="post" id="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Cargo_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
