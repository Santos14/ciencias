        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="page-body">
                    ...
                    {
                        $idanio_lectivo = $datos->idanio_lectivo;
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>Anio_lectivo_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idanio_lectivo" value="<?php echo $idanio_lectivo; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Anio_lectivo_c" class="btn btn-default shiny" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
