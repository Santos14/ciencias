...
<body class="no-skin" style="background:#f8f8f8 !important;">
        ...
        <div class="main-container" id="main-container"style="width: 931px;margin-left: 100px; height: 500px;">
          ...
          <?php include("includes/menu.inc") ; ?>
            <div class="main-content page-content" style="width: 950px; background:#f8f8f8;" >
                <div class="main-content-inner">
                    <center><img src="<?php echo base_url(); ?>public/img/pokebola.png" style="width: 300px;padding-top: 20px;"></img></center>
                    <!-- /.page-content -->
            ...
            <div class="footer" >
                <div class="footer-inner">
                    <div class="footer-content" style="width: 951px; left:100px;">
