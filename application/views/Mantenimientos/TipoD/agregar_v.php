            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                 ...
                 <?php
                    ...
                    {
                        $idtipo_discapacidad = $datos->idtipo_discapacidad;
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>TipoD_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idtipo_discapacidad" value="<?php echo $idtipo_discapacidad; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>TipoD_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
