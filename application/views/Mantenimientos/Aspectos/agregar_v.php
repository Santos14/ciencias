                ...
                <div class="main-content-inner">
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>Aspectos_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idaspecto" value="<?php echo $idaspecto; ?>">
                            ...
                            <label for="idasignatura">Nivel</label>
                            <select name="idnivel" id="" class="combobox form-control">
                                <option value=""></option>
                                <?php foreach($nivel as $value){
                                    if($idnivel == $value->idnivel){
                                    ?>
                                    <option selected value="<?php echo $value->idnivel; ?>"><?php echo $value->descripcion; ?></option>
                                    <?php }else{ ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Aspectos_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
