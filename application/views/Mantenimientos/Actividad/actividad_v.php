          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                        <div class="botones">
                            <a class="btn btn-success" href="<?php echo base_url(); ?>Actividad_c/nuevo">Agregar Nueva Actividad</a>
                            ...
                            <table class="table table-bordered table-striped table-condensed buscar" border>
                                ...
                                <tbody>
                                    <?php foreach ($datos as $value) {
                                        ?>
                                    <tr>
                                        <td><?php print $value->dac; ?></td>
                                        <td><?php print $value->da; ?></td>
                                        <td><?php print $value->estado; ?></td>
                                        <td><a href="<?php echo base_url()."Actividad_c/modificar/".$value->idactividad; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                        <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar esta Actividad?');"
                                        href="<?php echo base_url()."Actividad_c/eliminar/".$value->idactividad; ?>" ><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
