      ...
      <div class="container">
        <div class="row" >
          ...
          <div class="col-md-8 col-sm-6 col-xs-4">
            ...
            <a href="index.php#" class="visible-sm visible-xs menu-toggle"><i class="fa fa-bars"></i></a> </div>
          </div>
        </div>
      </div>
            ...
            <section class="listing-cont">
              <ul>
                <li class="item event-item">
                  ...
                  <div class="event-detail" style="width: 200px;">
                    <h4><a href="#" style="width: 200px;">Kermes Deportiva</a></h4>
                    <span class="event-dayntime meta-data">Sabado | 10:00 AM</span> </div>
                  ...
                  <li class="item event-item">
                    ...
                    <div class="event-detail" style="width: 200px;">
                      <h4><a href="#"  style="width: 200px;">Examenes Trimestrales</a></h4>
                      <span class="event-dayntime meta-data">Lunes | 07:00 AM</span> </div>
                      <div class="to-event-url">
                        <div><a href="#" class="btn btn-default btn-sm">Detalles</a></div>
                      </div>
                    </li>
              ...
              <div class="col-md-3 col-sm-3">
                ...
                <section class="listing-cont">
                  <marquee height="210" direction="up"onmouseout="this.start();" onmouseover="this.stop();">
                    <div class="example">
                      <div class="item-hover circle effect5"><a href="index.html#">
                        <div class="img"><img src="<?php echo base_url(); ?>public/img/blog-image3.jpg" height="400" width="600" alt="img"></div>
                        <div class="info" style="width: 180px;height: 180px;left: 20px;">
                          <div class="info-back">
                            <h3>Representante de Tenis</h3>
                            <p>Juegos Deportivos Lambayeque</p>
                          </div>
                        </div></a>
                      </div>
                      <div class="item-hover circle colored effect5"><a href="index.html#">
                       <div class="img"><img src="<?php echo base_url(); ?>public/img/blog-image2.jpg" alt="img"></div>
                       <div class="info" style="width: 180px;height: 180px;left: 20px;">
                        <div class="info-back">
                          <h3>PRIMER PUESTO</h3>
                          <p>Concurso de Matemáticas</p>
                        </div>
                      </div></a>
                    </div>
                    <div class="item-hover circle effect5"><a href="index.html#">
               ...
               <marquee width="630" height="178" align="bottom">
                <div class="container">
                 <div class="row" id="imagen" >
                    <div class="col-md-3 col-sm-3 col-xs-6"><img class="imagen img-responsive" src="<?php echo base_url(); ?>public/img/SAM_1.jpg" /></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img  class="imagen img-responsive" src="<?php echo base_url(); ?>public/img/SAM_2.jpg" /></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img class="imagen imagen-responsive" src="<?php echo base_url(); ?>public/img/SAM_3.jpg"/></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img class="imagen img-responsive" src="<?php echo base_url(); ?>public/img/SAM_4.jpg" /></div>
