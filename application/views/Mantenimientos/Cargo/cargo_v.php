          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                         <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>Cargo_c/nuevo">Agregar Nuevo Cargo</a>
                    ...
                    <table class="table table-bordered table-striped table-condensed buscar" border>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url()."Cargo_c/modificar/".$value->idcargo; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Cargo?');"
                                href="<?php echo base_url()."Cargo_c/eliminar/".$value->idcargo; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
