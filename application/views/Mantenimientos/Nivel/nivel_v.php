            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                    ...
                    <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>Nivel_c/nuevo">Agregar Nuevo Nivel</a>
                    ...
                    <table class="table table-bordered table-striped table-condensed buscar" border>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url()."Nivel_c/modificar/".$value->idnivel; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Nivel?');"
                                href="<?php echo base_url()."Nivel_c/eliminar/".$value->idnivel; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
