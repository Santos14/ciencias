          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                     <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>TipoS_c/nuevo">Agregar Nuevo Tipo de Sangre</a>
                    ...
                    <table class="table table-bordered table-striped table-condensed buscar" border>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url()."TipoS_c/modificar/".$value->idtipo_sangre; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Tipo de Sangre?');"
                                href="<?php echo base_url()."TipoS_c/eliminar/".$value->idtipo_sangre; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
