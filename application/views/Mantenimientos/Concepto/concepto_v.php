          ...
          <?php include("includes/menu.inc") ; ?>
            ...
            <div class="main-content" style="width: 950px; background:#f8f8f8;">
                <div class="main-content-inner">
                  <div class="contenido">
                        <div class="botones">
                        <a class="btn btn-success" href="<?php echo base_url(); ?>Concepto_c/nuevo">Agregar Nuevo Concepto de Pago</a>
                    ...
                    <table class="table table-bordered table-striped table-condensed buscar" border>
                        ...
                        <tbody>
                            <?php foreach ($datos as $value) {
                                ?>
                            <tr>
                                <td><?php print $value->dc; ?></td>
                                 <td><?php print $value->dtm; ?></td>
                                <td><?php print $value->estado; ?></td>
                                <td><a href="<?php echo base_url()."Concepto_c/modificar/".$value->idconcepto; ?>"><i id="btnModificar" class="fa fa-pencil"></i></a></td>
                                <td><a id="eliminar" onclick="return confirm('¿Esta Seguro de Eliminar este Concepto de Pago?');"
                                href="<?php echo base_url()."Concepto_c/eliminar/".$value->idconcepto; ?>" ><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
