                ...
                <div class="main-content-inner">
                 ...
                 <div class="row">
                     <div class="col-md-9">
                        ...
                        <form action="<?php echo base_url(); ?>Criterio_c/nuevo" method="post" id="form">
                            <h3><?php echo $titulo; ?></h3>
                            <input type="hidden" name="idcriterio" value="<?php echo $idcriterio; ?>">
                            <label for="descripcion">Descripcion</label>
                            <input class="form-control" type="text" name="descripcion" maxlength="40" value="<?php echo $descripcion; ?>" onpaste="return false" onkeypress="return sololetras(event)" required="required">

                            <label for="idasignatura">Asignatura</label>
                            <select name="idasignatura" id="" class="combobox form-control">
                                <option value=""></option>
                                <?php foreach($asignatura as $value){
                                    if($idasignatura == $value->idasignatura){
                                    ?>
                                    <option selected value="<?php echo $value->idasignatura; ?>"><?php echo $value->descripcion; ?></option>
                                    <?php }else{ ?>
                                    <option value="<?php echo $value->idasignatura; ?>"><?php echo $value->descripcion; ?></option>
                                <?php }} ?>
                            </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                     <center><a href="<?php echo base_url(); ?>Criterio_c" class="form-control btn btn-primary" id="btn2" type="button">CANCELAR</a></center>
                                </div>
                            </div>
                        </form>
                     </div>
