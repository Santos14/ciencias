...
<head>
  ...
  <script type="text/javascript">
    ...
    {
     var variable=document.getElementById("edads"+dato) ;  
     var vari=document.getElementById("edad"+dato) ; 
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#departamento').change(function(){
      ...
      $.get("<?php echo base_url().'RegAlumno_c/lista'; ?>",{'id':id},function(data){
        $('#provincia').empty();
    ...
    $('#provincia').change(function(){
      ...
      $.get("<?php echo base_url().'RegAlumno_c/lista1'; ?>",{'id1':id},function(data){
        $('#distrito').empty();
